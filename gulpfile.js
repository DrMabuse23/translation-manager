...
gulp.task('bundle:dependencies', function () {
  ...
  var defaultModules = ['assert', 'fs', 'buffer', 'console', 'constants', 'crypto', 'domain', 'events', 'http', 'https', 'os', 'path', 'punycode', 'querystring', 'stream', 'string_decoder', 'timers', 'tty', 'url', 'util', 'vm', 'zlib'],
...
gulp.task('serve', ['inject:css', 'compile:scripts:watch', 'compile:styles', 'misc'], function () {
  ...
  gulp.watch(srcDir + '/**/*.scss', ['compile:styles']);
  gulp.watch([serveDir + '/app.js',serveDir + '/classes/**/*.js', serveDir + '/browser/**/*.js'], electron.restart);
